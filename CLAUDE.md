...
>
> ⚠️ 21/08 — xác nhận lại với Công Lý: sơ tuyển **online, nộp lô, KHÔNG trừ
> thời gian** (không phải thi trực tiếp như bản v4 dưới đây từng giả định —
> giả định đó SAI, đã bỏ). `run.py` (đọc file truy vấn, chạy theo lô) là đúng
> thiết kế, không phải thiếu UI thao tác tay.
