...
> **`AGENTS.md` là nguồn chuẩn.** File này soi gương nguyên văn phần thân của
> `AGENTS.md` để công cụ chỉ đọc `CLAUDE.md` vẫn nhận đúng luật. Sửa nội dung ở
> `AGENTS.md` trước, rồi đồng bộ sang đây trong cùng một commit; khi hai file lệch
> nhau thì `AGENTS.md` thắng, sau đó kiểm lại `docs/contest.md` và code/config thật.
